...
import ApiInterceptorRequest from '@/http/ApiInterceptorRequest.ts';
import ApiInterceptorResponse from '@/http/ApiInterceptorResponse.ts';

import { HttpResponse } from './types';

export const __DEV__ = import.meta.env.VITE_ENV === 'dev';
export const __STAGING__ = import.meta.env.VITE_ENV === 'staging';
export const __PROD__ = import.meta.env.VITE_ENV === 'prod';
